...
- M06 adds an evidence-backed request→work→draft→review→provider→follow-up projection. Mail text is treated as evidence and cannot grant external mutation authority; uncertain provider status remains uncertain.
